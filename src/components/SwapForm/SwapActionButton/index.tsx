  ...
  const approveTooltipText = () => {
    ...
    return (
      <Trans>
        ...
        <a
          href="https://docs.oasisswap.com/kyberswap-solutions/kyberswap-interface/user-guides/instantly-swap-at-superior-rates#step-4-approve-contract-to-swap-tokens"
          target="_blank"
          rel="noreferrer"
        >
          Read more ↗
                  ...
                  <InfoHelper
                    ...
                    text={
                      <Trans>
                        ...
                        <a
                          href="https://docs.oasisswap.com/reference/permitable-tokens"
                          target="_blank"
                          rel="noreferrer"
                        >
                          Read more ↗
                    ...
                    <InfoHelper
                      text={
                        selected.value === AllowanceType.EXACT
                          ? 'You wish to give OasisSwap permission to use the exact allowance token amount as the amount in for this transaction, Subsequent transactions will require your permission again.'
                          : 'You wish to give OasisSwap permission to use the selected token for transactions without any limit. You do not need to give permission again unless revoke.'
                      }
                    />
                  </Flex>
                ) : null
