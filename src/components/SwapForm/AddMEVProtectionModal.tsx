      ...
      <Wrapper>
        ...
        <Row gap="12px">
          <Text fontSize={12} lineHeight="16px">
            <Trans>
              <ExternalLink href="https://docs.oasisswap.com/getting-started/foundational-topics/decentralized-finance/maximal-extractable-value-mev">
                MEV
              </ExternalLink>{' '}
              Protection safeguards you from front-running attacks on Ethereum. We suggest you employing the{' '}
              <ExternalLink href="https://docs.oasisswap.com/getting-started/foundational-topics/decentralized-technologies/rpc">
                RPC endpoint
              </ExternalLink>{' '}
              ...
              <ExternalLink href="https://docs.oasisswap.com/getting-started/quickstart/faq#how-to-change-rpc-in-metamask">
                guide
              </ExternalLink>
              .
            </Trans>
