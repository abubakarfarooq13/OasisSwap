      ...
      <Wrapper>
        ...
        <Row gap="12px">
          <Text fontSize={12} lineHeight="16px">
            <Trans>
              <ExternalLink href="#">MEV</ExternalLink> Protection safeguards you from front-running attacks on
              Ethereum. We suggest you employing the <ExternalLink href="#">RPC endpoint</ExternalLink> of reliable
              ...
              <ExternalLink href="#">guide</ExternalLink>.
            </Trans>
          </Text>
        </Row>
